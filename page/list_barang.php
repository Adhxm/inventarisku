...
<body>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            <?php
                ...
                $sql = "SELECT * FROM inventaris LEFT JOIN ruang ON inventaris.id_ruang = ruang.id_ruang WHERE 1=1 $q_cari LIMIT $mulai, $pembagian";
    ...
    <!-- pagination start -->
    <div class="anjir" style="float:right">
    <nav>
    <ul class="pagination">
    <li>
